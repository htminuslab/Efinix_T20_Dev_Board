...
// Git hash  : d17724707782673583610b3c9e55b79e22a76c77
...
module EfxSapphireSoc (
  ...
  wire       [3:0]    system_userTimer_0_logic_io_ctrl_rsp_payload_fragment_context;
  ...
  wire       [3:0]    system_userTimer_0_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_payload_fragment_context;
  ...
  wire       [3:0]    system_userTimer_0_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_rsp_payload_fragment_context;
  ...
  wire       [3:0]    system_userTimer_0_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_halfPipe_payload_fragment_context;
  ...
  reg        [3:0]    system_userTimer_0_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_rData_fragment_context;
  ...
  BmbDecoder_3 system_bmbPeripheral_bmb_decoder (
    ...
    .io_outputs_0_rsp_payload_fragment_context (system_bmbPeripheral_bmb_withoutMask_rsp_payload_fragment_context_5[3:0]        ), //i
  ...
  EfxTimerCtrl system_userTimer_0_logic (
    ...
    .io_ctrl_cmd_payload_fragment_context (system_userTimer_0_ctrl_slaveModel_arbiterGen_oneToOne_arbiter_cmd_halfPipe_payload_fragment_context[3:0]), //i
    ...
    .io_ctrl_rsp_payload_fragment_context (system_userTimer_0_logic_io_ctrl_rsp_payload_fragment_context[3:0]                                       ), //o
  ...
  assign when_PlicGateway_l21_2 = (! system_userTimer_0_interrupts_0_plic_gateway_waitCompletion);
  ...
  always @(*) begin
    ...
    case(system_plic_logic_bmb_cmd_payload_fragment_address)
      ...
      22'h002000 : begin
        ...
        system_plic_logic_bus_rsp_payload_fragment_data[19 : 19] = system_cores_0_externalInterrupt_plic_target_ie_2;
  ...
  assign system_cores_0_externalInterrupt_plic_target_requests_5_priority = system_userTimer_0_interrupts_0_plic_gateway_priority;
  assign system_cores_0_externalInterrupt_plic_target_requests_5_id = 5'h13;
  assign system_cores_0_externalInterrupt_plic_target_requests_5_valid = (system_userTimer_0_interrupts_0_plic_gateway_ip && system_cores_0_externalInterrupt_plic_target_ie_2);
      ...
      case(system_plic_logic_bmb_cmd_payload_fragment_address)
        ...
        22'h002000 : begin
          if(system_plic_logic_bus_doWrite) begin
            ...
            _zz_system_cores_0_externalInterrupt_plic_target_ie_2 <= system_plic_logic_bmb_cmd_payload_fragment_data[19];
...
module BmbDecoder_3 (
  ...
  assign logic_noHitS0 = (! (|{logic_hitsS0_5,{logic_hitsS0_4,{logic_hitsS0_3,{logic_hitsS0_2,{logic_hitsS0_1,logic_hitsS0_0}}}}}));
  ...
  always @(*) begin
    logic_input_ready = ((|{(logic_hitsS1_5 && io_outputs_5_cmd_ready),{(logic_hitsS1_4 && io_outputs_4_cmd_ready),{(logic_hitsS1_3 && io_outputs_3_cmd_ready),{(logic_hitsS1_2 && io_outputs_2_cmd_ready),{(logic_hitsS1_1 && io_outputs_1_cmd_ready),(logic_hitsS1_0 && io_outputs_0_cmd_ready)}}}}}) || logic_noHitS1);
    if(logic_cmdWait) begin
  ...
  assign logic_rspNoHitValid = (! (|{logic_rspHits_5,{logic_rspHits_4,{logic_rspHits_3,{logic_rspHits_2,{logic_rspHits_1,logic_rspHits_0}}}}}));
  ...
  always @(*) begin
    io_input_rsp_valid = ((|{io_outputs_5_rsp_valid,{io_outputs_4_rsp_valid,{io_outputs_3_rsp_valid,{io_outputs_2_rsp_valid,{io_outputs_1_rsp_valid,io_outputs_0_rsp_valid}}}}}) || (logic_rspPending && logic_rspNoHitValid));
